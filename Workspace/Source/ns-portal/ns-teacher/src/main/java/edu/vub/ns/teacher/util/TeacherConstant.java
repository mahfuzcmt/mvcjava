package edu.vub.ns.teacher.util;

import edu.vub.ns.webcore.util.Constant;

public interface TeacherConstant extends Constant   {
	...
	public static final String GET_MENU_JSON_TEMPLATE = "GetMenuJsonTemplate";
	public static final String GET_ROLE_BY_ROLEID = "GetAllRoleByRoleID";
